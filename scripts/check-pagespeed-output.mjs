...
assert.doesNotMatch(contact, /aria-hidden="true"><label for="q-website"/, "A armadilha anti-spam não pode esconder um campo focável da árvore de acessibilidade.");
assert.match(contact, /<input id="q-website"[^>]+ hidden/, "A armadilha anti-spam deve usar o atributo HTML hidden.");
