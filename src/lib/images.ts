...
export const GALLERY: { file: string; alt: string; altEn: string; portrait?: boolean }[] = [
  ...
  { file: "caca-tesouro-bau.jpeg", alt: "Ted vestido de pirata com uma criança junto à arca do tesouro", altEn: "Ted dressed as a pirate with a child beside the treasure chest", portrait: true },
  { file: "pulseira-te-amo.jpg", alt: "Pulseira artesanal feita numa oficina criativa", altEn: "Handmade bracelet created during a craft workshop" },
